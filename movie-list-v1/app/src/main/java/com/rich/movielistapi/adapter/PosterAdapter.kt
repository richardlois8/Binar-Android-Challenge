...
import com.rich.movielistapi.databinding.ItemMovieBinding
...
class PosterAdapter(private val listMovie : List<MovieResult>,private val viewPager2: ViewPager2) : RecyclerView.Adapter<PosterAdapter.ViewHolder>() {
    ...
    class ViewHolder(var binding : ItemMovieBinding, private var onClick : ((MovieResult) -> Unit)?) : RecyclerView.ViewHolder(binding.root) {
